...
class RES_JSON_API_Attachment
{
    ...
    public function RES_JSON_API_Attachment($wp_attachment = null)
    {
        if ($wp_attachment) {
    ...
    {
        $sizes = array('thumbnail', 'medium', 'large', 'full', 'mobyblogmedium', 'mobybloglarge');
